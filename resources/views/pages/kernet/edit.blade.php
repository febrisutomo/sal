@extends('layouts.app', ['title' => 'Edit Kernet'])

@section('content')
    <div class="container-fluid">
        <div class="page-header">
            <h4 class="page-title">Edit Kernet</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('armada.kernet.update', $kernet) }}" method="POST" class="needs-validation" novalidate
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group form-show-validation">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            ...
                                            value="{{ old('nama', $kernet->nama) }}" required>
                                        @error('nama')
